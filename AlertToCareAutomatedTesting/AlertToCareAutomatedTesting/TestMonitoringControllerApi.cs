...
namespace AlertToCareAutomatedTesting
{
    ...
    public class TestMonitoringControllerApi
    {
        ...
        public void TestAddNewVitalInfo()
        {
            ...
            VitalLogs vitalLogs = new VitalLogs { VitalsLogId = 201, PatientId = 1, BpmRate = 30.0, RespRate = 85.0, Spo2Rate = 90.0 };
        ...
        public void TestUpdateVitalInfoAtParticularVitalLogId()
        {
            ...
            request.AddHeader("Content-Type", "application/json");
            VitalLogs vitalLogs = new VitalLogs { VitalsLogId = 1, PatientId = 1, BpmRate = 36.0, RespRate = 85.0, Spo2Rate = 90.0 };
            request.AddJsonBody(vitalLogs);
            IRestResponse response = client.Execute(request);
            Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
        }
